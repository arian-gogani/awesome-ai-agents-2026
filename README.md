...
| [Nobulex](https://github.com/arian-gogani/nobulex) | Cryptographic receipt layer for AI agents. Ed25519-signed, JCS-canonical (RFC 8785) bilateral receipts — pre/post execution, hash-chained, independently verifiable without operator trust. EU AI Act Article 12 compliance primitive. MIT. |
